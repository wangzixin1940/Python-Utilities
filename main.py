...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.get_domain.clicked.connect(launchers.DevToolsLauncher.resolveDomainLauncher)
        self.ui.create_qr.clicked.connect(launchers.ExternalLauncher.qrcodeGeneratorLauncher)
        self.ui.resolve_qr.clicked.connect(launchers.ExternalLauncher.qrcodeParserLauncher)
