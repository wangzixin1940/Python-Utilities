...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.colorMaskChooseLabel.setText(QCoreApplication.translate("MainWindow", u"\u9009\u62e9ColorMask\uff1a", None))
        self.colorMaskChooseBox.setItemText(0, QCoreApplication.translate("MainWindow", u"SolidFillColorMask", None))
        self.colorMaskChooseBox.setItemText(1, QCoreApplication.translate("MainWindow", u"RadialGradiantColorMask", None))
        self.colorMaskChooseBox.setItemText(2, QCoreApplication.translate("MainWindow", u"SquareGradiantColorMask", None))
        self.colorMaskChooseBox.setItemText(3, QCoreApplication.translate("MainWindow", u"HorizontalGradiantColorMask", None))
        self.colorMaskChooseBox.setItemText(4, QCoreApplication.translate("MainWindow", u"VerticalGradiantColorMask", None))

        self.pictureChooseButton.setText(QCoreApplication.translate("MainWindow", u"\u9009\u62e9\u7167\u7247\uff08\u53ef\u9009\uff09", None))
