...
"\u81ea\u52a8\u7ba1\u7406\u60a8\u7684\u9f20\u6807\u548c\u952e\u76d8\u64cd\u4f5c\uff0c\u53ea\u7528\u5199\u4e00\u4e2a\u7b80\u5355\u7684\u5b8f\u3002", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.title.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.title.setText(QCoreApplication.translate("Dialog", u"AMK App", None))
        self.choose_file.setText(QCoreApplication.translate("Dialog", u"\u70b9\u51fb\u8fd9\u4e2a\u6309\u94ae\uff0c\u9009\u62e9\u60a8\u7684\u5b8f\u6587\u4ef6", None))
        self.run_script.setText(QCoreApplication.translate("Dialog", u"\u8fd0\u884c\u60a8\u7684\u5b8f\u6587\u4ef6", None))
    # retranslateUi
