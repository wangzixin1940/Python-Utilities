            ...
            match text:
                ...
                case "=":
                    try:
                        ...
                        msgbox.showerror("Error", "The divisor cannot be 0!")
                        self.data = []
                    except ValueError:
                        msgbox.showerror(
                            "Error", "The expression overflow!(bigger than 10**4301-1)")
                        self.data = []
