...
class App(ttk.Window):
    def __init__(self):
        ...
        self.licence_label = ttk.Label(self, text="Licence Type: ", font=("Arial", 15))
        ...
        # Create the subtitle
        self.params_label = ttk.Label(self, text="Parameters: ", font=("Arial", 15, "bold"))
        self.params_label.grid(row=3, column=0, pady=10, padx=10)
        # Create the parameters entry
        self.name_label = ttk.Label(self, text="Name of author: ", font=("Arial", 12))
        ...
        self.usage_label = ttk.Label(self, text="Usage (GPL): ", font=("Arial", 12))
        ...
        self.project_name_label = ttk.Label(self, text="Project name (GPL): ", font=("Arial", 12))
        ...
        self.create_button = ttk.Button(self, text="Create", command=self.create_licence)
    ...
    def create_licence(self):
        ...
        if path:
            ...
            path.close()
            msgbox.showinfo("Success", "Licence successfully created and saved!")
